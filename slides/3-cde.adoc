...
image::images/eclipseche.png[width=40%]
(2014 - Supporté par Codenvy)

[NOTE.speaker]
--
* Premier CDE basé sur des conteneurs Docker
* Rapidement le concept des devfiles est incubé au sein du projet
* EN 2019 Eclipse che supporte officiellement les devfiles
--
